  ...
  child: Text(""),
            ...
            Container( 
              ...
              child: Column(children:[
                Center(child: Image.asset("images/logo.jpg", width: MediaQuery.of(context).size.width* 0.7,fit: BoxFit.cover,)),
                ...
                Material(
                  ...
                  child: Container(
                    ...
                    child: Column(children: [
                      ...
                      Text(
                        "Login",
                        style: AppWidget.HeadlineTextFeildStyle().copyWith(fontSize: 30,),
                      ),
                      SizedBox(
                        height: 30.0,
                      ),
